# Support for Output Descriptors in Duncoin Core

Since Duncoin Core v0.17, there is support for Output Descriptors. This is a
...
on Duncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Duncoin Core wallets, a convenience function `combo` is
