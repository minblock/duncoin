...
const char * const BITCOIN_CONF_FILENAME = "duncoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Duncoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Duncoin";
#else
    // Unix
    return pathRet / ".duncoin";
#endif
#endif
}
