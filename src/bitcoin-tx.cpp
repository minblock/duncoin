...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " duncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  duncoin-tx [options] <hex-tx> [commands]  Update hex-encoded duncoin transaction\n" +
            "or:     duncoin-tx [options] -create [commands]   Create hex-encoded duncoin transaction\n" +
            "\n";
