...
"""Verify that starting duncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start duncoin with -h for help text")
        ...
        self.log.info("Start duncoin with -version for version information")
        ...
        self.log.info("Start duncoind with -fakearg to make sure it does not start")
